...
class PostLikeMentor extends StatefulWidget {
  final String uid;
  final postId;
  const PostLikeMentor({Key? key, this.postId, required this.uid})
      : super(key: key);

  @override
  State<PostLikeMentor> createState() => _PostLikeMentorState();
}

class _PostLikeMentorState extends State<PostLikeMentor> {
  @override
  void initState() {
    super.initState();
  }
