...
class QuestionsCommentsTextScreen extends StatefulWidget {
  final String userUid;
  final String token;
  final String postId;
  const QuestionsCommentsTextScreen(
      {Key? key,
  ...
  @override
  State<QuestionsCommentsTextScreen> createState() =>
      _QuestionsCommentsTextScreenState();
}

class _QuestionsCommentsTextScreenState
    extends State<QuestionsCommentsTextScreen> {
  ...
  void postComment(
    ...
    try {
      String res = await FireStoreQuestionMethods().questionCommentImage(
        widget.postId,
  ...
  void postCommentText(String uid, String name, String profImage) async {
    ...
    try {
      String res = await FireStoreQuestionMethods().questionCommentText(
        widget.postId,
        commentEditingController.text,
        uid,
        name,
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // Wait for the first frame to be drawn before scrolling
      _scrollToEnd();
    });
  }
