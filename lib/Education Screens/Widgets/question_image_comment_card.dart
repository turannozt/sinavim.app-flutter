...
class CommentQuestionImageCard extends StatefulWidget {
  final snap;
  final String postId;
  const CommentQuestionImageCard({
    Key? key,
    required this.snap,
  ...
  @override
  State<CommentQuestionImageCard> createState() =>
      _CommentQuestionImageCardState();
}

class _CommentQuestionImageCardState extends State<CommentQuestionImageCard> {
          ...
          return AlertDialog(
            ...
            content: Row(
              ...
              children: [
                InkWell(
                  onTap: () {
                    FireStoreQuestionMethods().deleteComment(
                      ...
                      onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => HeroWidgetPost(
                              postUrl:
                                  widget.snap.data()['imageUrl'].toString(),
                            ),
                          )),
                      child: Image.network(
                        widget.snap.data()['imageUrl'],
                        fit: BoxFit.cover,
                      ),
                    ),
              ...
              children: [
                LikeAnimation(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () => FireStoreQuestionMethods().likeCommentPost(
                      widget.postId,
