...
class CommentQuestionCard extends StatefulWidget {
  final snap;
  final String postId;
  const CommentQuestionCard({
    Key? key,
    required this.snap,
  ...
  @override
  State<CommentQuestionCard> createState() => _CommentQuestionCardState();
}

class _CommentQuestionCardState extends State<CommentQuestionCard> {
  String? username;
