...
class NeKadarCalistim extends StatefulWidget {
  const NeKadarCalistim({super.key});

  @override
  State<NeKadarCalistim> createState() => _NeKadarCalistimState();
}

class _NeKadarCalistimState extends State<NeKadarCalistim> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('posts')
            .where('tag', isEqualTo: 'Ne Kadar Çalıştım')
