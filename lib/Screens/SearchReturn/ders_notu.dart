...
class DersNotu extends StatefulWidget {
  const DersNotu({super.key});

  @override
  State<DersNotu> createState() => _DersNotuState();
}

class _DersNotuState extends State<DersNotu> {
