...
class RekorBende extends StatefulWidget {
  const RekorBende({super.key});

  @override
  State<RekorBende> createState() => _RekorBendeState();
}

class _RekorBendeState extends State<RekorBende> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('posts')
            .where('tag', isEqualTo: 'Rekor Bende')
